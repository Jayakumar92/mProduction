...
import leora.com.baseapp.model.dbmodel.MaerialAuditModel;
...
public class DbSQLiteHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table if not exists " + Constants.TBL_CONFIG + " (id integer primary key, syncbucket_last_sync_time text, table_drop_time text)");
        db.execSQL("create table if not exists " + Constants.TBL_RAW_MATERIAL + " (id integer primary key, slug text, name text DEFAULT '', type text, ref_id text, created_on text, updated_on text, last_sync_time text)");
        db.execSQL("create table if not exists " + Constants.TBL_RAW_MATERIAL_AUDIT + " (id integer primary key, slug text, mertric_count text, audit_type text, supplier_name text , audit_date text, comment text , status text, raw_material_ref_id text, created_on text, updated_on text, last_sync_time text)");
    ...
    public MaterialModel getMaterialModel(String id) {
        ...
        Cursor cursor = getCompleteTable(Constants.TBL_RAW_MATERIAL);
        MaterialModel materialModel = (MaterialModel) setModel(MaterialModel.class, cursor);
    ...
    public ArrayList<MaterialModel> getMaterialModels() {
        ...
        while (cursor.moveToNext()) materialModels.add(setProfileModel(cursor));
        cursor.close();
    ...
    public ArrayList<MaerialAuditModel> getMaterialAuditModels() {
        ArrayList<MaerialAuditModel> materialAuditModels = new ArrayList<MaerialAuditModel>();
    ...
    public MaterialModel setProfileModel(Cursor cursor) {
        return (MaterialModel) setFieldsValues(MaterialModel.class, cursor);
    }

    public MaerialAuditModel setMaterialAuditModel(Cursor cursor) {
        return (MaerialAuditModel) setFieldsValues(MaerialAuditModel.class, cursor);
    }
